...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const FAQS = [
    ...
    { q: 'Do you offer packages for brides and families?', a: 'Yes \u2014 we offer bridal, pre-bridal and family combo packages. Message us on WhatsApp for current package details and pricing.' },
  ];
