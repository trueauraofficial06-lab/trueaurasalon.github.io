...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const SERVICES = [
    // ---- HAIR ----
    { cat: 'hair', name: 'Haircut & Styling', desc: 'Precision cuts and finish styling for every hair type.' },
    { cat: 'hair', name: 'Hair Color / Global Color', desc: 'Full-head colour using premium international brands.' },
    ...
    { cat: 'hair', name: 'Hair Spa & Deep Conditioning', desc: 'Nourishing therapy to restore shine and strength.' },
    { cat: 'hair', name: 'Hair Extensions', desc: 'Seamless length and volume, matched to your natural hair.' },
    { cat: 'hair', name: 'Bridal & Party Hairstyling', desc: 'Elegant updos and styles for your big day.' },

    // ---- MAKEUP ----
    { cat: 'makeup', name: 'Party Makeup', desc: 'Glam, long-lasting makeup for events and celebrations.' },
    ...
    { cat: 'skin', name: 'Cleanup', desc: 'Quick refresh to clear impurities and restore glow.' },
    { cat: 'skin', name: 'De-Tan Treatment', desc: 'Removes sun tan and evens out skin tone.' },
    { cat: 'skin', name: 'Skin Polishing', desc: 'Gentle exfoliation for soft, radiant skin.' },
    { cat: 'skin', name: 'Bleach', desc: 'Instant brightening for face and body.' },
    { cat: 'skin', name: 'Threading & Waxing', desc: 'Precise, gentle hair removal for a clean finish.' },
